package com.platform.lbchildren.module.resource.controller;
...
public class ResourceController {
    ...
    @PreAuthorize("hasAuthority('resource:progress:update')")
    ...
    @PreAuthorize("hasAuthority('resource:progress:view')")
